    ...
    <div>
      ...
      {mostrarForm && (
        <div className="bg-white rounded-xl shadow p-4 mb-4 max-w-lg mx-auto">
          <h2 className="text-lg font-bold text-green-700 mb-4">Registrar Obrero</h2>
      ...
      {obreros.length === 0 ? (
        ...
        <div className="space-y-3">
          {obreros.map((obrero) => (
            <div key={obrero.id}
              className={`bg-white rounded-xl shadow p-4 border-l-4 ${obrero.pagado ? "border-green-500" : "border-red-500"}`}>
              <div className="flex justify-between items-start gap-2">
                ...
                <div className="flex flex-col items-end gap-2">
                  <button
                    ...
                    className={`px-3 py-2 rounded-lg font-bold text-white text-sm whitespace-nowrap ${obrero.pagado ? "bg-green-500 hover:bg-green-600" : "bg-red-500 hover:bg-red-600"}`}>
