    ...
    <div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        <div className="bg-white rounded-xl shadow p-6 text-center">
          ...
          <p className="text-4xl font-bold text-green-700">{insumos.length}</p>
        </div>
        <div className="bg-white rounded-xl shadow p-6 text-center">
      ...
      {mostrarForm && (
        <div className="bg-white rounded-xl shadow p-6 mb-6 max-w-lg mx-auto">
          <h2 className="text-xl font-bold text-green-700 mb-4">Registrar Insumo</h2>
          ...
          {insumos.map((insumo) => (
            <div key={insumo.id} className="bg-white rounded-xl shadow p-6 hover:shadow-lg transition duration-200">
              <div className="flex justify-between items-start">
                <h3 className="text-xl font-bold text-green-700">{insumo.nombre}</h3>
